  ...
  return new Vuex.Store({
    ...
    actions: {
      ...
      addPost(vuexContext, post) {
        ...
        return this.$axios.$post('https://nuxtappudemy.firebaseio.com/posts.json' +
      ...
      editPost(vuexContext, editedPost) {
        return this.$axios.$put(`https://nuxtappudemy.firebaseio.com/posts/${editedPost.id}.json?auth=` +
